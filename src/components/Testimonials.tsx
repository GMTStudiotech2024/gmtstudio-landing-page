...
const Testimonials: React.FC = () => {
  return (
    <section id="testimonials" className="py-10 bg-gray-400 text-black dark:text-white dark:bg-gray-900 justify-center">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="text-4xl font-bold text-black dark:text-white mb-8">GMTStudio WorkSpace</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="max-w-sm p-6 bg-gray-200 dark:bg-gray-800 rounded-lg shadow-lg transform transition-transform hover:scale-105 duration-300 ease-in-out">
              <FaQuoteLeft className="text-2xl text-black dark:text-gray-600 mb-4" />
              <p className="text-lg text-black dark:text-gray-300 mb-4">"{testimonial.quote}"</p>
              <FaQuoteRight className="text-2xl text-dark dark:text-gray-600 mb-4" />
