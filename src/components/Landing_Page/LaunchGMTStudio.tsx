        ...
        >
          <div className="relative">
            <input
              ...
              className="shadow-[0_0_30px_#3B82F6] w-full py-3 pl-5 pr-12 bg-white text-black dark:bg-black rounded-full dark:text-white placeholder-gray-500 dark:placeholder-gray-400 border border-black dark:border-white focus:outline-none focus:ring-0 focus:border-transparent transition duration-300 ease-in-out focus:shadow-[0_0_30px_#3B82F6]"
              value={searchTerm}
          ...
          >
            <div className="text-white text-center max-w-md mx-auto">
              <motion.div
                ...
                className="mb-5"
              >
                <TbEggCracked className="w-20 h-20 mx-auto" />
              </motion.div>
              <motion.h2
              ...
              >
                Clue: Searching for intelligent support <strong>"is"</strong> the answer.
              </motion.p>
              <button
