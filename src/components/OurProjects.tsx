      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8" data-aos="fade-up">
          {projects.map((project, index) => (
            <div className="group max-w-2xl rounded-3xl border border-gray-100 bg-gray-200 p-6 shadow-2xl shadow-gray-600/10 dark:border-gray-700 dark:bg-gray-900 dark:shadow-none sm:p-8 transform transition-transform hover:scale-105 duration-300 ease-in-out" key={index}>
              <div className="relative overflow-hidden rounded-xl shadow-xl shadow-rose-600/40 transition duration-500 group-hover:scale-105 group-hover:shadow-md">
                <img src={project.image} alt={project.title} loading="lazy" className="h-72 w-full object-cover object-top" />
              </div>
