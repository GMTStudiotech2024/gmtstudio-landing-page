    ...
    >
      <div className="absolute top-4 right-4 text-right mt-14">
        <div className="animated-fade-in-up">
          ...
          <a href="#projects" className="inline-block px-10 py-4 font-semibold rounded-lg shadow-md bg-gray-400 dark:bg-black text-white dark:text-white transform transition-transform duration-500 hover:scale-105">
            Learn More
          </a>
        </div>
      </div>
