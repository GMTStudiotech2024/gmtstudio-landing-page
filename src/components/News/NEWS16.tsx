    ...
    <div className="bg-gray-100 dark:bg-gray-900 min-h-screen flex flex-col">
      <main className="flex-grow container mx-auto px-4 py-8">
        <article className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
          ...
          />
          <div className="p-6">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">Mazs AI is now in GMTStudio Official Website</h1>
            ...
            <div className="prose dark:prose-invert max-w-none text-gray-800 dark:text-gray-200">
              <p className="lead text-xl mb-6">
                We change GMTStudio AI Studio to our official website and change the name to Mazs AI Lab.
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4">Project Highlights</h2>
              <p>
                Also, we updated Mazs AI to version 1.1, here are some key changes:
                <p>We step one foot foward to Enhance Mazs AI output function, which we make it when generating sentence, one word in a sentence will add up into user input and predict next word of the sentence. </p>
                <p>The three model Anatra, Canard, and pato are still exist but will not be available in official website. the original model will be Mazs AI v1.1 anatra, which is our enhanced version of the original model.</p>
                </p>
                <h2>Mazs AI v1.1 Anatra model information</h2>
                <h3 className="text-xl font-semibold mt-6 mb-3">Model Architecture</h3>
                <p>
                  Mazs AI v1.1 Anatra is built on a sophisticated multi-layered architecture:
                </p>
                ...
                <p>
                  While compact compared to large language models, Mazs AI v1.1 Anatra boasts:
                </p>
                <ul className="list-disc pl-6 mb-4">
                ...
                <p className="mt-4">
                  This focused design allows Mazs AI v1.1 Anatra to excel in GMTStudio-specific tasks while maintaining strong general conversational abilities.
                </p>
