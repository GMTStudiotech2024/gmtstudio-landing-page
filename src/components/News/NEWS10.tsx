    ...
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen flex flex-col">
      <main className="flex-grow container mx-auto px-4 py-8">
        <article className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden max-w-4xl mx-auto">
          ...
          />
          <div className="p-8">
            <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">GMTStudio's Official website Update</h1>
            ...
            <div className="prose dark:prose-invert max-w-none text-gray-800 dark:text-gray-200">
              ...
              <ul className="list-disc pl-6 mb-6">
                <li>Update News page: We manage to put our recent and past Blog and News to the News page, which you can track our improvement and updates easily.</li>
                <li>Project Learning: although we develop our website by ourself, but we use AI as the tool to improve and fix our bugs, Here we will teach you how to write a fully website by using AI</li>
                <li>Sign Up and Login: WE updated a new button when you click on the head icon, it has a Sign Up / Login there, it is not functional yet because we haven't set up the backend of this function,which we are currently on development</li>
              ...
              <ul className="list-disc pl-6 mb-6">
                <li>enhance UI</li>
                <li>Sign Up and login system</li>
